...
<%
    ...
    try(Connection connection = dbcp.getConnection()){
        ...
        ArrayList<Task> taskList1 = getTaskList(rst);
        rst = stm.executeQuery("SELECT * FROM Task WHERE status = 'COMPLETED'");
        ArrayList<Task> completedTaskList2 = getTaskList(rst);
        request.setAttribute("taskList1", taskList1);
        request.setAttribute("completedTaskList1", completedTaskList2);
